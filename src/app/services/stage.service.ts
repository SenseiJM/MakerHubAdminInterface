...
import { StageAddDTO } from '../interfaces/StageAddDTO';
...
export class StageService {
  ...
  AddStage(nouvStage: StageAddDTO): Observable<StageAddDTO[]> {
    return this._client.post<StageAddDTO[]>(this.url + "api/Stage", nouvStage);
  }
